...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> deleteNote() async {
    if (notes.isNotEmpty) {
      await DatabaseService.deleteNote(notes.first.id);
      fetchNotes();
    }
  }
  ...
  Future<void> deleteTheme() async {
    if (themes.isNotEmpty) {
      await DatabaseService.deleteTheme(themes.last.id);
      fetchThemes();
    }
  }
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        TextButton(onPressed: addNote, child: const Text('+')),
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        TextButton(onPressed: addTheme, child: const Text('+')),
                        const SizedBox(width: 4),
                        const Text('themes'),
                        const SizedBox(width: 4),
                        TextButton(
